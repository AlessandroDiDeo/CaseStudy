...
shinyUI(navbarPage(
  ...
  tabPanel("Plot",
           sidebarLayout(
             sidebarPanel(
               sliderInput("DOSE", "Dose in children below 9 kg (mg/kg)",  min = 0.1, max = 2, step = 0.1, value = 0.1),
               sliderInput("DOSE2", "Dose patients > 9 kg (mg/kg)",  min = 0.1, max = 2, step = 0.1, value = 0.1),
